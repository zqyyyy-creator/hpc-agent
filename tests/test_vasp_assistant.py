...
from modules.claude_code_reporter import (
    _build_prompt,
...
from modules.job_query import _local_output_dir_for_input_path
...
def test_outcar_parser_extracts_deterministic_energies():
    from modules.vasp_outcar_parser import parse_vasp_results, format_facts_block
...
def test_outcar_parser_handles_converged_calculation():
    from modules.vasp_outcar_parser import parse_vasp_results
